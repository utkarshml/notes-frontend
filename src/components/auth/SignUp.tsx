    ...
    <AuthLayout>
      <Card className="shadow-medium border-0">
        <CardHeader className="text-center space-y-1">
          ...
          <CardDescription>
            {step === 'email' ? 'Enter your details to get started' : 'Enter the verification code'}
          </CardDescription>
        </CardHeader>
          ...
          {step === 'email' ? (
            ...
            <form onSubmit={handleOtpSubmit} className="space-y-4">
              ...
              <div onClick={handleResend}>
                <Button variant='link'  className="text-sm cursor-pointer font-bold text-primary ext-muted-foreground">
                  Resend Otp
                  </Button>
              </div>
              <Button type="submit" className="w-full" disabled={isLoading}>
